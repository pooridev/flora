        ...
        <div className='CheckOutPayment'>
                ...
                <div className='OrderPayment__shipping d-flex-spacebetween'>
                    ...
                    <div className='OrderPayment__shipping--option'>
                        ...
                        <div className='OrderPayment__shipping--optionbox d-flex'>
                            <label htmlFor="Flat">Flat rate:<span>AED 20</span></label>
                        ...
                        <div className='OrderPayment__shipping--optionbox d-flex'>
                            <label htmlFor="Local">Local pickup:<span>AED 25</span></label>
            ...
            <div className='CheckOutPayment__shipping--option'>
                ...
                <div className='OrderPayment__shipping--optionbox d-flex'>
                    ...
                    <label htmlFor="Payment">Cheque Payment
                    </label>
                ...
                <div className='OrderPayment__shipping--optionbox d-flex'>
                    ...
                    <label htmlFor="PayPal ">
                        <div className='d-flex'><p>PayPal</p> <img alt='paypal' src={paypal}/> <Link>What is PayPal?</Link></div>
                    </label>
                </div>
            </div>
            ...
            <div className='CheckOutForm__checkbox reviewform-row'>
                <div className='d-flex CheckOutForm__checkbox-box'>
                    ...
                    <label className='CheckOutForm__label chechbox-label' htmlFor='conditions'>
