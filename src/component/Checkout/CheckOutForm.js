            ...
            <form className='CheckOutForm--form'>
                ...
                <div className='CheckOutForm__checkbox reviewform-row'>
                    <div className='d-flex CheckOutForm__checkbox-box'>
                        ...
                        <label className='CheckOutForm__label chechbox-label' for='createacount'>Create an
                            account?</label>
                    </div>
                    <div className='d-flex CheckOutForm__checkbox-box'>
                        <input type='checkbox' id='createacount'/>
                        <label className='CheckOutForm__label chechbox-label' for='createacount'>Ship to a different
                            address?</label>
                    </div>
